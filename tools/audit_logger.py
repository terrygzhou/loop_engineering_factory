...
class AuditLog:
            ...
            "node.output",
            {
                ...
                "output_summary": {
                    k: (
                        ...
                        else f"{type(v).__name__}({len(str(v))})"
                    )
    ...
    def log_artifact_written(
        self, artifact_name: str, file_path: str, size_bytes: int
    ) -> dict:
    ...
    def log_user_input(
        self, interaction_type: str, phase: str, question: str, source: str = "api"
    ) -> dict:
    ...
    def log_user_response(
        self, interaction_type: str, phase: str, response: dict, source: str = "api"
    ) -> dict:
    ...
    def log_api_call(
        self, endpoint: str, method: str, workflow_id: str, status: int = 200
    ) -> dict:
        """Log an API call."""
        return self._log(
            "api.call",
    ...
    def log_file_write(
        self, phase: str, file_path: str, content_type: str, size_bytes: int
    ) -> dict:
